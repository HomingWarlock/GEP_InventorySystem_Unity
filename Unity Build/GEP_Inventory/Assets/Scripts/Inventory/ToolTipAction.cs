...
public class ToolTipAction : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        if (eventData.button == PointerEventData.InputButton.Right)
        {
            ...
            dropped_item.transform.position = new Vector3(player_object.transform.position.x + drop_distance, player_object.transform.position.y * 1.5f, player_object.transform.position.z + drop_distance);
